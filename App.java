...
public class App {
    ...
    public static void main(String[] args) {
        ...
        //CartItem item1 = new CartItem(tacalog.findById("P001"), 2);
        ...
        CartItem singleApple = new CartItem(a, 1);
        CartItem twoApples = new CartItem(a, 2);
        CartItem fiveSodas = new CartItem(b, 5);
        CartItem tenSodas = new CartItem(b, 10);
        CartItem normalBread = new CartItem(c, 3);
